...
import { Play, TrendingUp, TrendingDown, Target, Sparkles, Plus, DollarSign } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";
import { Progress } from "@/components/ui/progress";
import { visions, projectionTheory } from "@/data/visions";
      ...
      <div className="container px-4">
        ...
        <div className="mb-20 text-center relative">
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-bold mb-8 italic tracking-tight">
            The <span className="text-sky-400">Projects</span> Horizon
          </h1>
            ...
            {visions.map((vision) => (
              <Card key={vision.id} className="bg-slate-900 border-slate-800 hover:border-sky-500/30 transition-all group overflow-hidden">
                ...
                <CardFooter className="pb-6">
                  <Button className="w-full bg-slate-800 hover:bg-slate-700 text-slate-50 rounded-xl">
                    View Full Story
                  </Button>
                </CardFooter>
              </Card>
